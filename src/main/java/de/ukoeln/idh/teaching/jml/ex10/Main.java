...
public class Main {
	...
	public static void main(String[] args) throws ResourceInitializationException, CASException,
		...
		AnalysisEngineDescription neDetector = AnalysisEngineFactory.createEngineDescription(NEDetector.class);

		AnalysisEngineDescription neCounter = AnalysisEngineFactory.createEngineDescription(NECounter.class);


		SimplePipeline.runPipeline(crd, tokenizer, neDetector, neCounter);
